...
const sampledpData: ProblemFormData = {
...
const sampleStringProblem: ProblemFormData = {
...
type CodeEditorLanguage = "javascript" | "python" | "java";
...
const languageMap: Record<CodeEditorLanguage, string> = {
...
const CreateProblemForm = () => {
    ...
    const loadSampleData = () => {
        ...
        replaceTags(sampleData.tags.map((tag) => ({ name: tag.name })));
                            ...
                            <Card key={language} className="bg-slate-50 dark:bg-slate-950/20">
                                ...
                                <CardContent className="space-y-6">
                                    ...
                                    <Card>
                                        ...
                                        <CardContent>
                                            <Controller
                                                name={`codeSnippets.${language}` as `codeSnippets.${LanguageKey}`}
                                                control={control}
                                                render={({ field }) => (
                                                    <CodeEditor
                                                        value={field.value}
                                                        onChange={field.onChange}
                                                        language={language.toLowerCase() as CodeEditorLanguage}
                                                    />
                                                )}
                                            />
                                            {(errors.codeSnippets as any)?.[language] && (
                                                <p className="text-sm text-red-500 mt-2">
                                    ...
                                    <Card>
                                        ...
                                        <CardContent>
                                            <Controller
                                                name={`referenceSolutions.${language}` as `referenceSolutions.${LanguageKey}`}
                                                control={control}
                                                render={({ field }) => (
                                                    <CodeEditor
                                                        value={field.value}
                                            ...
                                            {(errors.referenceSolutions as any)?.[language] && (
                                                <p className="text-sm text-red-500 mt-2">
                                                    {(errors.referenceSolutions as any)[language]?.message}
                                                </p>
                                            )}
                                        </CardContent>
                                    </Card>
                                        ...
                                        <CardContent>
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                <div>
                                                    ...
                                                    />
                                                    {(errors.examples as any)?.[language]?.input && (
                                                        <p className="text-sm text-red-500 mt-1">
                                                            {(errors.examples as any)[language]?.input?.message}
                                                        </p>
                                                    )}
                                                </div>
                                                <div>
                                                    ...
                                                    <Textarea
                                                        ...
                                                        className="mt-2 min-h-20 resize-y font-mono"
                                                    />
                                                    {(errors.examples as any)?.[language]?.output && (
                                                        <p className="text-sm text-red-500 mt-1">
                                                            {(errors.examples as any)[language]?.output?.message}
                                                        </p>
                                                    )}
                                                </div>
                                                <div className="md:col-span-2">
                                                    ...
                                                    <Textarea
                                                        {...register(`examples.${language}.explanation` as any)}
